...
def ResUNet_classification(num_features, num_outputs, args):
    """构建 ResUNet 模型，用于classification"""
    inputs = layers.Input(shape=(num_features, 1))
    ...
    # 分类分支----------------------------------------------------------------------
    c = layers.Conv1D(1024, kernel_size=1, activation='relu',name='classification_branch')(b1)
